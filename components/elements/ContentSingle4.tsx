...
export default function ContentSingle4({ image = "/assets/imgs/page/img-1.webp", classList = "", separationLine = "", separation = "" }: { image?: string; classList?: string; separationLine?: string; separation?: string }) {
    return (
        <div className="position-relative z-3 mt-n70px">
            <div id="content" className="content">
                <div className="d-flex flex-column gap-3">
                    <div className="bg-card border-300 p-4 rounded-6 shadow-1 rounded-6 d-flex flex-column gap-3">
                        <div>
                    ...
                    <div>
                        <div className="d-flex align-items-center justify-content-between gap-2">
                            <div className="information justify-content-start">
                                <a href="#" className="tag has-dot text-nowrap">
                                ...
                                <a href="#comments" className="comment d-flex align-items-center fs-8 gap-1 text-800">
                        ...
                        <div className="row g-2 mt-3">
                            ...
                            <div className="d-flex justify-content-between gap-md-4 gap-0 pt-3">
                                ...
                                <div className="d-flex align-items-center gap-2 pt-1">
                                    <Link href="/single-5" className="author size-70 d-flex align-items-center gap-2">
                                    ...
                                    <div className="w-75">
                                        ...
                                        <h6 className="hover-underline mb-0">
                                            <Link href="/single-5" className="text-truncate-2">
