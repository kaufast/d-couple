...
export default function ContentSingle1({ image = "/assets/imgs/page/img-1.webp", classList = "", separationLine = "", separation = "" }: { image?: string; classList?: string; separationLine?: string; separation?: string }) {
    return (
        <div className="row main-content position-relative pt-4">
            <div className="block-outline d-none d-lg-block">
                <div className="row">
            ...
            <div className="col-lg-7 mx-auto position-relative z-3">
                <div id="content" className="content">
                    <div className="d-flex flex-column gap-3">
                        <div className="px-md-5">
                            ...
                            <p className={`text-700 text-center fs-5 mb-3 ${separationLine}`}>{separation}</p>
                        ...
                        <Image className="rounded-6 overflow-hidden cover-image" src={image} alt="Article featured image" width={1200} height={600} sizes="(max-width: 768px) 100vw, 1200px" />
                            ...
                            <div className="row g-2 mt-4">
                                        ...
                                        <div className="d-flex align-items-center gap-2">
                                            <div className="card-img-container rounded-8 size-38 overflow-hidden">
                                                <Link href="/page-author" className="card-img">
                                                    <Image className="cover-image" src="/assets/imgs/template/author/author-4.webp" alt="Article author" width={38} height={38} />
                                                </Link>
                                            </div>
                                ...
                                <div className="d-flex justify-content-between gap-md-4 gap-0 pt-3">
                                    <div className="d-flex align-items-center gap-2 pt-1">
                                        <Link href="/single-7" className="author size-70 d-flex align-items-center gap-2">
                                            <Image className="rounded-8 cover-image" src="/assets/imgs/page/img-161.webp" alt="Related post thumbnail" width={70} height={70} />
                                        </Link>
                                        <div className="w-75">
                                            ...
                                            <h6 className="hover-underline mb-0">
                                                <Link href="/single-7" className="text-truncate-2">
                                    ...
                                    <div className="d-flex align-items-center gap-2 pt-1">
                                        <Link href="/single-2" className="author size-70 d-flex align-items-center gap-2">
                                            <Image className="rounded-8 cover-image" src="/assets/imgs/page/img-34.webp" alt="Related post thumbnail" width={70} height={70} />
                                        </Link>
                                        <div className="w-75">
                                            <ul className="m-0 ps-3">
                                                <li>
                                            ...
                                            <h6 className="hover-underline mb-0">
                                                <Link href="/single-2" className="text-truncate-2">
                        ...
                        <div className="px-md-5">
                            ...
                            <div className="d-flex flex-wrap flex-lg-nowrap gap-3 align-items-start pt-4">
                                <div className="d-block">
                                    <div className="avatar avatar-lg rounded-6 m-0 overflow-hidden border-4 border-white shadow-1 z-2 hover-up-scale">
                                        <Image className="cover-image rounded-6" src="/assets/imgs/template/author/author-18.webp" alt="Commenter avatar" width={60} height={60} />
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className="d-flex flex-wrap flex-lg-nowrap gap-3 align-items-start pt-4">
                                <div className="d-block">
                                    <div className="avatar avatar-lg rounded-6 m-0 overflow-hidden border-4 border-white shadow-1 z-2 hover-up-scale">
                                        <Image className="cover-image rounded-6" src="/assets/imgs/template/author/author-3.webp" alt="Commenter avatar" width={60} height={60} />
                                    </div>
                                </div>
                                <div>
                                    <div className="d-flex flex-wrap gap-2 align-items-center">
                            ...
                            <div className="ps-5">
                                <div className="d-flex flex-wrap flex-lg-nowrap gap-3 align-items-start pt-4">
                                    <div className="d-block">
                                        <div className="avatar avatar-lg rounded-6 m-0 overflow-hidden border-4 border-white shadow-1 z-2 hover-up-scale">
                                            <Image className="cover-image rounded-6" src="/assets/imgs/template/author/author-19.webp" alt="Commenter avatar" width={60} height={60} />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="d-flex flex-wrap gap-2 align-items-center">
