...
export default function SideBar({ displayFlashNews = true, displayTopAuthors = true, displayFollowUs = true, displayTrendingTopics = true, displayAds = true }: { displayFlashNews?: boolean; displayTopAuthors?: boolean; displayFollowUs?: boolean; displayTrendingTopics?: boolean; displayAds?: boolean }) {
        ...
        <SidebarStickyWrapper topSpacing={50} bottomSpacing={50}>
            <div className="sidebar_right">
                <div className="row">
                    ...
                    <div className={`col-md-6 col-12 col-lg-12 ${displayTrendingTopics ? "" : "d-none"} order-md-2 order-2 order-lg-2`}>
                        <div className="trending-topics pt-4">
                            <span className="fs-8 fw-bold text-uppercase">Trending Topics</span>
                    ...
                    <div className={`col-md-6 col-12 col-lg-12 ${displayAds ? "" : "d-none"} order-lg-3`}>
