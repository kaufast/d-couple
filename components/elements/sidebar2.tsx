...
import TrendingCategoryCard from "@/components/cards/TrendingCategoryCard";
...
export default function SideBar2({ displayFlashNews = true, displayTopAuthors = true, displayFollowUs = true, displayTrending = true, displayTrendingTopics = true, displayAds = true }: { displayFlashNews?: boolean; displayTopAuthors?: boolean; displayFollowUs?: boolean; displayTrending?: boolean; displayTrendingTopics?: boolean; displayAds?: boolean }) {
    // Mock data - should be moved to JSON file
    const flashNewsData = [
        {
            classList: "pt-0",
            classCard: "",
        ...
        {
            classList: "d-md-none d-block d-lg-block",
            classCard: "",
            linkPost: "/single-1",
            linkCategory: "/archive-1",
            linkAuthor: "/page-author",
    ...
    const trendingData = {
        ...
        items: [
            {
                classList: "border-top-400",
                classCard: "flex-row-reverse",
                linkPost: "/single-1",
                linkCategory: "/archive-1",
                linkAuthor: "/page-author",
                img: "/assets/imgs/page/img-55.webp",
                title: "Time slowly fades where moss grows",
                date: "Jun 13, 2025",
            },
            {
                ...
                linkCategory: "/archive-1",
                linkAuthor: "/page-author",
                img: "/assets/imgs/page/img-56.webp",
                title: "The weight of light in endless fields",
                date: "Jun 13, 2025",
            },
            {
                classList: "",
                classCard: "flex-row-reverse border-0",
                linkPost: "/single-1",
                linkCategory: "/archive-1",
                linkAuthor: "/page-author",
                img: "/assets/imgs/page/img-57.webp",
                title: "What the fire gently leaves behind",
                date: "Jun 13, 2025",
            },
        ],
    ...
    const trendingTopicsData = [
        {
            img: "/assets/imgs/page/img-58.webp",
            alt: "foks",
            linkPost: "/single-1",
            linkCategory: "/archive-1",
            title: "Lifestyle",
    ...
    return (
        <SidebarStickyWrapper topSpacing={50} bottomSpacing={50}>
            <div className="sidebar_right">
                <div className="row">
                    <div className={`col-md-6 col-12 col-lg-12 ${displayFlashNews ? "" : "d-none"}`}>
                    ...
                    <div className={`col-md-6 col-12 col-lg-12 ${displayTopAuthors ? "" : "d-none"}`}>
                        <div className="top-author pt-4 pt-md-0 pt-lg-4 border-bottom pb-4">
                    ...
                    <div className={`col-md-6 col-12 col-lg-12 ${displayFollowUs ? "" : "d-none"} order-md-2 order-1 order-lg-1`}>
                    ...
                    <div className={`col-md-6 col-12 col-lg-12 ${displayTrending ? "" : "d-none"} order-md-1 order-2 order-lg-2`}>
                        <div className="trending pt-4">
                            <span className="fs-8 fw-bold text-uppercase">Trending</span>
                            <div className="card-blog-wrapper pt-3 pb-2">
                                <CardBlog5 card={trendingData.featured} idx={0} />
                            </div>
                            {trendingData.items.map((card, idx) => (
                                <CardBlog3 key={idx} card={card} idx={idx} />
                            ))}
                        </div>
                    </div>

                    <div className={`col-md-6 col-12 col-lg-12 ${displayTrendingTopics ? "" : "d-none"} order-lg-3`}>
                        <div className="trending-topics pt-4">
                            <span className="fs-8 fw-bold text-uppercase">Explore Trending Topics</span>
                            <div className="group-topics pt-3 swiper slider-1 position-relative">
                                <SwiperDynamicServer
                                ...
                                >
                                    {trendingTopicsData.map((card, idx) => (
                                        <div className="swiper-slide" key={idx}>
                                            <TrendingCategoryCard card={card} idx={idx} />
                                        </div>
                                    ))}
                                </SwiperDynamicServer>
                                <div className="position-absolute bottom-0 end-0 d-flex gap-6px z-1">
                    ...
                    <div className={`col-md-6 col-12 col-lg-12 ${displayAds ? "" : "d-none"} order-lg-4`}>
                        <div className="block-ads text-center mt-4">
                            <h6 className="text-600 z-1">Your banner here</h6>
                            <h6 className="text-600 z-1">310 x 220</h6>
                            <div className="button pt-4 z-1">
                                <Link href="/page-contact" className="btn btn-dark d-inline-block">
