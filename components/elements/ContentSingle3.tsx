...
export default function ContentSingle3({ image = "/assets/imgs/page/img-1.webp", classList = "", separationLine = "", separation = "", outlineClassList = "" }: { image?: string; classList?: string; separationLine?: string; separation?: string; outlineClassList?: string }) {
    return (
            ...
            <div id="content" className="content">
                <div className="d-flex flex-column gap-3">
                    <div>
                        ...
                        <div className={`bg-card border-300 p-3 rounded-6 shadow-1 rounded-6 overflow-hidden mb-4 ${outlineClassList}`}>
                    ...
                    <div>
                        ...
                        <div className="row g-2 mt-4">
                            ...
                            <div className="d-flex justify-content-between gap-md-4 gap-0 pt-3">
                                ...
                                <div className="d-flex align-items-center gap-2 pt-1">
                                    <Link href="/single-4" className="author size-70 d-flex align-items-center gap-2">
                                    ...
                                    <div className="w-75">
                                        ...
                                        <h6 className="hover-underline mb-0">
                                            <Link href="/single-4" className="text-truncate-2">
                                        ...
                                        <div className="form-group">
                                            <div className="checkbox">
                                                <div className="custome-checkbox">
                                                    ...
                                                    <label className="form-check-label label_info" htmlFor="save_account">
