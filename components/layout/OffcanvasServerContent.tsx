...
import OffcanvasInteractive from "./OffcanvasInteractive";
import ThemeSwitcher from "@/util/ThemeSwitcherServer";
import CloseSidebarButtonWrapper from "./CloseSidebarButtonWrapper";
...
export default function OffcanvasServerContent() {
    return (
        <>
            ...
            <OffcanvasInteractive />

            <div className="flash-news d-flex flex-column pt-4">
            ...
            <div className="block-social-icons pt-4 pb-4">
                <p className="fs-8 fw-bold text-uppercase mb-2">Follow Us</p>
                <div className="group-social-icons flex-nowrap pt-2">
                    <a href="#" className="social-item w-50 hover-up">
                        <span className="icon">
