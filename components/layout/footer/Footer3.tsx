...
export default function Footer() {
    return (
        <footer>
            <div className="section-footer-3 overflow-hidden pb-50">
                            ...
                            <div className="row g-4 justify-content-between">
                                ...
                                <div className="col-lg-5 col-md-5 col-8">
                                    ...
                                    {popularArticles.map((article, idx) => (
                                        <div key={idx} className={`card-blog card-3 hover-up hover-zoom-image flex-row-reverse border-0 ${article.classList}`}>
                                            <div className="card-body">
                                                <h6 className="mb-2 hover-underline">
                                                    <Link href={article.linkPost} className="text-truncate-2">
                                                        <span className="card-title fs-7">{article.title}</span>
                                                    </Link>
                                                </h6>
                                                <div className="information">
                                                    <div className="date">
                                                        <span className="dot"></span>
                                                        <span className="text fs-8 fw-medium">{article.date}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="card-img-container d-inline-flex">
                                                <Link href={article.linkPost} className="card-img size-75">
                                                    <Image src={article.img} alt={article.title} width={75} height={75} />
                                                </Link>
                                            </div>
                                        </div>
                                    ))}
