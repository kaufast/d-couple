...
export default function Footer() {
    return (
        <footer>
            <div className="section-footer-2 pb-50 overflow-hidden">
                            ...
                            <div className="row g-4 justify-content-between">
                                    ...
                                    <ul className="list-unstyled ps-0">
                                        <li className="mb-3 hover-up">
                                            <div className="pb-2 border-bottom">
                                                <div className="card-body d-flex">
                                                    <div>
                                                        <span className="badge-number me-3 align-self-start">1</span>
                                                    </div>
                                                    <div className="d-flex flex-column">
                                                        <h6 className="mb-1 hover-underline">
                                                            <Link href="/single-1" className="text-truncate-2">
                                                                <span className="card-title fs-6"> Beneath the soil, seeds whisper about another day </span>
                                                            </Link>
                                                        </h6>
                                                    </div>
                                                </div>
                                        ...
                                        <li className="mb-3 hover-up">
                                            <div className="pb-2 border-bottom">
                                                <div className="card-body d-flex">
                                                    <div>
                                                        <span className="badge-number me-3 align-self-start">2</span>
                                                    </div>
                                                    <div className="d-flex flex-column">
                                                        <h6 className="mb-1 hover-underline">
                                                            <Link href="/single-2" className="text-truncate-2">
                                                                <span className="card-title fs-6"> The sea that quietly forgets our names </span>
                                                            </Link>
                                                        </h6>
                                                    </div>
                                                </div>
                                        ...
                                        <li className="mb-3 hover-up">
                                            <div className="pb-2">
                                                <div className="card-body d-flex">
                                                    <div>
                                                        <span className="badge-number me-3 align-self-start">3</span>
                                                    </div>
                                                    <div className="d-flex flex-column">
                                                        <h6 className="mb-1 hover-underline">
                                                            <Link href="/single-3" className="text-truncate-2">
                                                                <span className="card-title fs-6"> When the mountains breathe at first dawn </span>
                                                            </Link>
                                                        </h6>
                                                    </div>
                                                </div>
                                ...
                                <div className="col-lg-3 col-md-3 col-6 d-none d-md-block">
                                    ...
                                    <ul className="list-unstyled ps-0">
                                        ...
                                        <li className="mb-3">
                                            <Link className="text-dark link-effect-1" href="/page-term">
