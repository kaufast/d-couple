...
const mostComments = [
    { number: 1, linkPost: "/single-1", title: "Beneath the soil, seeds whisper about another day" },
    { number: 2, linkPost: "/single-2", title: "The sea that quietly forgets our names" },
    { number: 3, linkPost: "/single-3", title: "When the mountains breathe at first dawn" },
    { number: 4, linkPost: "/single-4", title: "How the desert softly dreams of rain" },
];
...
const instagramImages = [
    { img: "/assets/imgs/page/img-11.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-12.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-13.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-14.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-15.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-16.webp", alt: "foks" },
];
                ...
                <div className="container">
                    <div className="row g-4">
                        <div className="col-lg-3 col-md-6">
                            <div className="border-top-900 pt-4">
                                ...
                                <ul className="ps-3 m-0 mb-4">
                                    ...
                                    <li>
                                        <span className="fs-8 text-700">+1 628-234-6708</span>
                                    </li>
                                </ul>
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="border-top-900 pt-4">
                                ...
                                <ul className="list-unstyled ps-0">
                                    {mostComments.map((item, idx) => (
                                        <MostCommentsItem key={idx} card={item} idx={idx} isLast={idx === mostComments.length - 1} />
                                    ))}
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 col-12 d-none d-md-block">
                            <div className="border-top-900 pt-4">
                                <p className="fs-8 fw-bold text-uppercase mb-2">Popular Articles</p>
                                {popularArticles.map((card, idx) => (
                                    <CardBlog7 key={idx} card={card} idx={idx} />
                                ))}
                            </div>
                        </div>
                            ...
                            <div className="border-top-900 pt-4">
                                ...
                                <div className="d-flex flex-wrap gap-2 mb-4">
                                    {instagramImages.map((item, idx) => (
                                        <Link key={idx} href="#" className="hover-up hover-zoom-image size-75 rounded-4 overflow-hidden">
                                            <span className="card-img">
                                                <Image className="cover-image" src={item.img} alt={item.alt} width={75} height={75} />
                                            </span>
                                        </Link>
                                    ))}
                                </div>
