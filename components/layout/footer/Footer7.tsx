...
const categoriesData = [
    { link: "/archive-1", text: "Lifestyle" },
    { link: "/archive-2", text: "Business" },
    { link: "/archive-3", text: "Science" },
    { link: "/archive-4", text: "Technology" },
    { link: "/archive-5", text: "Gaming" },
    { link: "/archive-6", text: "Other" },
];

const utilityPagesData = [
    { link: "#", text: "Style Guide" },
    { link: "#", text: "Private policy" },
    { link: "/page-term", text: "Term & Condition" },
    { link: "#", text: "Subscribe" },
    { link: "#", text: "Advertise" },
];
...
export default function Footer7() {
    return (
        <footer>
            <div className="section-footer-4 pb-4 overflow-hidden">
                <div className="container border-top-900 pt-5">
                    <div className="row g-4">
                        <div className="col-lg-3 col-md-5 col-12">
                            <div>
                                <Link className="navbar-brand d-flex align-items-center gap-1" href="/">
                                    <Image className="dark-mode-invert" src="/assets/imgs/template/logo/favicon.svg" alt="Logo" width={24} height={24} />
                                    <strong className="fs-5 text-nowrap">Foks.</strong>
                                </Link>
                                <p className="fs-7 text-dark mt-4 mb-4">Crafted for writers and storytellers, Oris offers a modern, timeless space where your words truly belong.</p>
                                <Link href="/page-contact" className="btn btn-outline px-0 bg-transparent border-0">
                                    <span className="text-nowrap text-decoration-underline">Contact</span>
                        ...
                        <div className="col-lg-2 col-md-3 col-6 offset-md-1">
                            <p className="fs-8 fw-bold text-uppercase mb-2">Categories</p>
                            <ul className="list-unstyled ps-0">
                                {categoriesData.map((cat, idx) => (
                                    <li className="mb-2" key={idx}>
                                        <Link className="text-dark link-effect-1" href={cat.link}>
                                            <span className="text-1">{cat.text}</span>
                                            <span className="text-2">{cat.text}</span>
                                        </Link>
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="col-lg-2 col-md-3 col-6">
                            ...
                            <ul className="list-unstyled ps-0">
                                {utilityPagesData.map((page, idx) => (
                                    <li className="mb-2" key={idx}>
                                        <Link className="text-dark link-effect-1" href={page.link}>
                                            <span className="text-1">{page.text}</span>
                                            <span className="text-2">{page.text}</span>
                                        </Link>
                                    </li>
                                ))}
                            </ul>
                        ...
                        <div className="col-lg-4 col-md-6 col-12">
                            <div>
                                ...
                                <div className="group-social-icons pt-2">
                                    <Link href="#" className="social-item hover-up">
                                        <span className="icon">
                                ...
                                <ul className="ps-3 m-0 mt-4">
                                    <li>
                                        <span className="fs-8 text-700">San Francisco, CA, USA</span>
                                    </li>
                                    <li>
                                        <span className="fs-8 text-700">hello@foks.com</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
