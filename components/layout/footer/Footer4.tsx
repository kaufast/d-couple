                ...
                <div className="container">
                    <div className="row g-4">
                        ...
                        <div className="col-lg-3 col-md-6 col-12 d-none d-md-block">
                            ...
                            {/* prettier-ignore */}
                            {popularArticlesData.map((card, idx) => (
                        ...
                        <div className="col-lg-3 col-md-6 col-12">
                            <div className="row g-4 justify-content-between">
                                <div className="col-6">
                                    ...
                                    <ul className="list-unstyled ps-0">
                                        {categoriesCol1.map((category, idx) => (
                                            <li key={idx} className="mb-3">
                                                <Link className="text-dark link-effect-1" href={category.link}>
                                                    <span className="text-1">{category.name}</span>
                                                    <span className="text-2">{category.name}</span>
                                                </Link>
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                <div className="col-6">
                                    <ul className="list-unstyled ps-0 pt-3">
                                        {categoriesCol2.map((category, idx) => (
                                            <li key={idx} className="mb-3">
                                                <Link className="text-dark link-effect-1" href={category.link}>
                                                    <span className="text-1">{category.name}</span>
                                                    <span className="text-2">{category.name}</span>
