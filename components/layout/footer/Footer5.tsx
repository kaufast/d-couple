...
const galleryImages = [
    { img: "/assets/imgs/page/img-10.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-9.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-8.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-7.webp", alt: "foks" },
    { img: "/assets/imgs/page/img-6.webp", alt: "foks" },
    ...
    { img: "/assets/imgs/page/img-19.webp", alt: "foks" },
];

const categoriesLinks = [
    { name: "Lifestyle", href: "/archive-1" },
    { name: "Business", href: "/archive-2" },
    { name: "Science", href: "/archive-3" },
    { name: "Technology", href: "/archive-4" },
    { name: "Gaming", href: "/archive-5" },
    { name: "Other", href: "/archive-6" },
];

const navigationLinks = [
    { name: "Home", href: "/" },
    { name: "About us", href: "/about-us" },
    { name: "Author posts", href: "/page-author" },
    { name: "Search results", href: "/page-search-results" },
...
const utilityLinks = [
    ...
    { name: "Term & Condition", href: "/page-term" },
    { name: "Subscribe", href: "#" },
    { name: "Advertise", href: "#" },
];
...
export default function Footer() {
    return (
        <footer>
            <div className="section-footer overflow-hidden pt-4">
                        ...
                        <div className="col-lg-5 col-md-7">
                            ...
                            <div className="d-flex flex-wrap gap-2 mb-4">
                                {galleryImages.map((item, idx) => (
                                    <div key={idx} className="hover-up hover-zoom-image size-56 overflow-hidden d-inline-flex">
                                        <div className="card-img">
                                            <Image className="cover-image" src={item.img} alt={item.alt} width={56} height={56} />
                                        </div>
                                    </div>
                                ))}
                            </div>
                                    ...
                                    <ul className="list-unstyled ps-0">
                                        {categoriesLinks.map((link, idx) => (
                                            <li key={idx} className="mb-2">
                                                <Link className="text-dark link-effect-1" href={link.href}>
                                                    <span className="text-1">{link.name}</span>
                                ...
                                <div className="col-lg-3 col-md-3 col-6 d-none d-md-block">
                                    ...
                                    <ul className="list-unstyled ps-0">
                                        {utilityLinks.map((link, idx) => (
                                            <li key={idx} className="mb-2">
                                                {link.href === "#" ? (
                                                    <a className="text-dark link-effect-1" href={link.href}>
                                                        <span className="text-1">{link.name}</span>
                                                        <span className="text-2">{link.name}</span>
                                                    </a>
                                                ) : (
