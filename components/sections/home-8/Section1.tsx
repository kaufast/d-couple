...
import CardBlog13 from "@/components/cards/CardBlog13";
...
export default function Section1() {
    return (
        <section className="sec-1-home-8 pt-70 pb-40 overflow-hidden">
                        ...
                        <div className="row g-5 g-md-4">
                                ...
                                <div className="card-feature">
                                    <Link href="/archive-4" className="tag has-dot green text-nowrap rounded-pill">
                                        <span className="text-nowrap link-effect-1">
                                            <span className="text-1">Hello world!</span>
                                            <span className="text-2">Hello world!</span>
                                        </span>
                                    </Link>
                                    <h1 className="mb-2 mt-2 h4">
                                        <span className="text-truncate-3">Thoughts, insights, and moments designed to fuel your creativity</span>
                                    </h1>
                                        ...
                                        <div className="author-card style-1">
                                            <div className="card-img-container">
                                                <Link href="/page-author" className="card-img">
                                                    <Image className="cover-image" src="/assets/imgs/template/author/author-12.webp" alt="d-couple" width={38} height={38} />
                                                </Link>
                                            </div>
                            ...
                            <div className="col-md-6 col-12">
                                ...
                                {trendingData.map((card, idx) => (
                                    <CardBlog13 key={idx} card={card} idx={idx} />
                                ))}
                            </div>
                        </div>
                    </div>
