...
export default function Section1() {
    return (
        <section className="sec-1-single-5 pb-70 overflow-hidden">
            <div className="container">
                <div className="row main-content align-items-end">
                    ...
                    <div className="col-lg-12 pt-4">
                        <div className="border-bottom-400"></div>
                    </div>
                </div>
                <div className="row main-content position-relative mt-0 g-5">
                    <div className="col-lg-7 col-md-10 mt-4">
                        <ContentSingle3 classList="" separationLine="" separation="" outlineClassList="" image="/assets/imgs/page/img-167.webp" />
                    </div>
                    <div className="col-lg-4 mt-4 offset-lg-1">
                        <SideBar2 displayFlashNews={true} displayTopAuthors={true} displayFollowUs={true} displayTrending={true} displayTrendingTopics={false} displayAds={false} />
                    </div>
                </div>
            </div>
        </section>
