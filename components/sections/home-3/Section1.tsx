...
export default function Section1() {
    return (
        <section className="sec-1-home-3 pt-5 overflow-hidden">
            <div className="container pb-5">
                <div className="row">
                    <div className="col-12">
                        <div className="text-center">
                            <div className="size-50 rounded-6 overflow-hidden icon-shape justify-content-center d-inline-flex align-items-center">
                                <Image className="cover-image" src="/assets/imgs/template/author/author-12.webp" alt="author" width={50} height={50} />
                            </div>
                            <h5>Thomas Foks</h5>
                            <p className="fs-7 text-700 mb-4">Thoughts, stories and ideas.</p>
                    ...
                    <div className="col-12">
                        <p className="fs-8 fw-bold text-uppercase mb-2 mt-4">Featured Article</p>
                    </div>
                </div>
                <div className="row">
                    <div className="col-12">
                        <div className="swiper slider-1 position-relative">
                            <SwiperDynamicServer
