...
export default function Section2Interactive({ blogCards }: Section2InteractiveProps) {
    ...
    const displayedItems = blogCards.slice(startIndex, endIndex);
    ...
    return (
        <>
            ...
            {totalPages > 1 && (
                <div className="text-center mt-2 pb-60">
                    <nav>
