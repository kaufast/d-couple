...
export default function Section4() {
    return (
        <section className="sec-4-home-7 pb-100 overflow-hidden">
                ...
                <div className="row">
                    <div className="col-12">
                        <div className="text-center">
                            ...
                            <h2 className="mt-2">Let's talk with me</h2>
                        </div>
                    </div>
                </div>
                <div className="row pt-4">
                    <div className="col-lg-8 col-12 mx-auto">
                        <div className="contact-form rounded-6 border-300 bg-card p-md-5 p-4 shadow-4">
                            <div className="row g-5">
                                ...
                                <div className="col-lg-5">
                                    ...
                                    <ul className="m-0 mt-2 list-unstyled ps-0">
                                        ...
                                        <li className="mb-1">
                                            <a href="https://maps.app.goo.gl/EBrRJL69eUWH1PzG8" className="fs-6 text-dark fw-medium">
