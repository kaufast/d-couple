...
export default function Section1() {
    return (
        <section className="sec-1-single-1 pb-70 overflow-hidden">
            <div className="container">
                <div className="row main-content">
                    ...
                    <div className="col-lg-6 pb-4 pb-lg-0">
                        ...
                        <h1 className="mt-2 mb-3 h2">When nature stops waiting for us to return</h1>
                        <p className="fs-18 text-dark fw-medium mb-4">There comes a time when the wild no longer looks for us. Forests learn to grow without footsteps, and rivers forget the sound of bridges.</p>
                        <div className="information pt-3 mt-3 justify-content-start">
                            <Link href="/page-author" className="author">
                                <span className="author-img">
                                    <Image className="size-24" src="/assets/imgs/template/author/author-1.webp" alt="d-couple" width={24} height={24} />
                                </span>
                    ...
                    <div className="col-lg-6">
                        <div className="image w-100 h-100">
                            <Image className="w-100 cover-image" src="/assets/imgs/page/img-1.webp" alt="d-couple" width={800} height={400} />
                        </div>
                    </div>
                    <div className="col-lg-12">
                        <div className="line-dot mt-5"></div>
                    </div>
                </div>
                <ContentSingle1 classList="d-none" separationLine="d-none" separation="" image="/assets/imgs/page/img-160.webp" />
            </div>
        </section>
    );
}
