                ...
                <div className="row g-4">
                    <div className="col-lg-6">
                        <div className="block-img-contact d-flex align-items-center gap-3 mb-3">
                            <div className="image">
                                <Image src="/assets/imgs/page/img-1.webp" alt="contact" className="cover-image" width={150} height={150} />
                            </div>
                            <div className="image">
                                <Image src="/assets/imgs/page/img-120.webp" alt="contact" className="cover-image" width={150} height={150} />
                            </div>
                            <div className="image">
                                <Image src="/assets/imgs/page/img-102.webp" alt="contact" className="cover-image" width={150} height={150} />
                            </div>
                        </div>
                        ...
                        <p className="mb-3">We're open to new opportunities and ready to take on your next project. Whether you already have a clear vision or simply need professional guidance, our team is here to help.</p>
                        <p>Feel free to reach out via email or give us a call — we'd love to collaborate with you!</p>

                        <div className="d-flex align-items-center gap-5">
                            <div>
                                <p className="fs-8 fw-bold text-uppercase mb-0">Let's Connect</p>
                                <ul className="m-0 mt-2 list-unstyled ps-0">
                                    ...
                                    <li className="mb-1">
                                        <a href={EXTERNAL_URLS.GOOGLE_MAPS_LOCATION} className="fs-6 text-dark fw-medium" target="_blank" rel="noopener noreferrer">
                            ...
                            <div className="ms-md-5">
                                <ul className="m-0 mt-2 list-unstyled ps-0 pt-3">
                                    <li className="mb-1">
                                        <span className="fs-6 text-dark fw-medium">Monday- Friday: 8:00am-9:30pm</span>
                                    </li>
                                    <li className="mb-1">
                                        <span className="fs-6 text-dark fw-medium">Saturday: 8:00am-4:30pm</span>
                                    </li>
                                    <li className="mb-1">
                                        <span className="fs-6 text-dark fw-medium">Sunday: Closed</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-5 offset-lg-1 col-12">
                        ...
                        <form action="#" className="row g-2 mt-3">
                            ...
                            <div className="col-12">
                                <textarea className="form-control" name="message" placeholder="Your message...." aria-label="With textarea"></textarea>
                            </div>

                            <div className="form-group">
                                <div className="checkbox">
                                    <div className="custome-checkbox">
                                        <input className="form-check-input" type="checkbox" name="checkbox" id="terms" />
                                        <label className="form-check-label label_info ms-1" htmlFor="terms">
                                            <span className="ms-1">
                                                I have read and agree to the
                                                <Link href="/page-term" className="text-dark text-decoration-underline">
                                                    {" "}
                                                    terms
                                                </Link>
                                            </span>
                            ...
                            <div className="col-12 pt-4">
                                <button type="submit" className="btn btn-dark btn-medium w-100">
                    ...
                    <div className="col-12 mt-5">
                        <div className="contact-map">
                            <iframe src={EXTERNAL_URLS.GOOGLE_MAPS_EMBED} width="600" height="450" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="Contact Map"></iframe>
                        </div>
                    </div>
                </div>
            </div>
