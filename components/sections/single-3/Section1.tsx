    ...
    return (
        <section className="sec-1-single-3 pb-70 overflow-hidden">
            <div className="container">
                        ...
                        <div className="card-blog card-9 position-relative">
                            ...
                            <div className="card-body border-0 mb-4">
                                <div className="information justify-content-start">
                                    ...
                                    <span className="readers d-flex align-items-center gap-1 fs-8 text-white changeless">
                                    ...
                                    <Link href="#comments" className="comment d-flex align-items-center fs-8 gap-1 text-white changeless">
                                ...
                                <h1 className="mt-2 text-white changeless h2">
                                ...
                                <div className="information pt-3 mt-3 justify-content-start">
                                    ...
                                    <div className="date">
                                        <span className="dot bg-white changeless"></span>
                                        <span className="text-white changeless fs-8 fw-medium">January 25, 2025</span>
                                    </div>
                                    <div className="read-time">
                                        <span className="dot bg-white changeless"></span>
                                        <span className="text-white changeless fs-8 fw-medium">6 mins read</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <ContentSingle1 classList="" separationLine="line-dot" separation="" image="/assets/imgs/page/img-155.webp" />
            </div>
        </section>
    );
}
